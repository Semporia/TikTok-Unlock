...
[English Version](https://github.com/Semporia/TikTok-Unlock/blob/master/README_EN.md)
> 目录
...
* iOS系统版本：16.3 （支持向下兼容）
* TikTok Version : 27.9.0（前置操作：从 [iTunes for Windows V 12.6.5.3](https://pan.baidu.com/s/1gLKF-W_GFhYgEYRP8yMA8g?pwd=Code) 抓包 TikTok Version 21.1.0 安装，登陆后观看视频、直播、评论、点赞、发布视频等模块都正常使用后，再从 App Store 升级至最新版方可使用！）
* TikTok TestFlight
